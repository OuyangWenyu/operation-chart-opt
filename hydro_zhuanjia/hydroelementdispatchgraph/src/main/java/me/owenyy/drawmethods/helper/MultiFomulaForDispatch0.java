...
import com.wenyu.hydroelements.operation.basic.MultiFomula;
import com.wenyu.hydroelements.operation.basic.MultiFomulaMode;

/**
 * 固定水头损失+无顶托下游水位流量+最大发电引用流量控制最大出力
 * @author  OwenYY
 *
 */
public class MultiFomulaForDispatch0 implements MultiFomulaMode {
	...
	public double maxPowerState(double Hnet) {
		double value=MultiFomula.calMaxPower(hsSpec.getPowerInstalled(), hsSpec.getGenerateInflowMax(), Hnet,
				hsSpec.getOutputCoefficient());
		return value;
	}
